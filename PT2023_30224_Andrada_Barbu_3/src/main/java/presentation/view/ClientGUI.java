...
public class ClientGUI extends JFrame {
    ...
    public ClientGUI()
    {
        ...
        panel=new JPanel();
        b1=new JButton("Adaugare client");
        b2=new JButton("Editare client");
        b3=new JButton("Sterge client");
        b4=new JButton("Vizualizare clienti");
    ...
    /**
     * Adds an ActionListener for the "Adaugare client" button.
     *
     * @param ac the ActionListener to be added
     */
    public void addAdaugareClientListener(ActionListener ac) {
        b1.addActionListener(ac);
    }
    /**
     * Adds an ActionListener for the "Vizualizare clienti" button.
     *
     * @param vc the ActionListener to be added
     */
    public void addVizualizareClientiListener(ActionListener vc) {
        b4.addActionListener(vc);
    }
    /**
     * Adds an ActionListener for the "Sterge client" button.
     *
     * @param sc the ActionListener to be added
     */

    public void addStergereClientListener(ActionListener sc) {
        b3.addActionListener(sc);
    }

    /**
     * Adds an ActionListener for the "Editare client" button.
     *
     * @param ec the ActionListener to be added
     */
    public void addEditareClientListener(ActionListener ec) {
